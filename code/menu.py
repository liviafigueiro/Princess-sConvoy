...
from code.Const import WIN_WIDTH, C_ORANGE, MENU_OPTION, C_WHEAT, C_GOLD, WIN_HEIGHT
    ...
    def run(self):
        ...
        while True:
            ...
            for i in range(len(MENU_OPTION)):
                ...
                if i == menu_option:
                    self.menu_text(30, MENU_OPTION[i], C_GOLD, ((WIN_WIDTH / 2), 200 + 25 * i))
                else:
                    self.menu_text(30, MENU_OPTION[i], C_WHEAT, ((WIN_WIDTH / 2), 200 + 25 * i))
            ...
            self.menu_text(
                16,
                'Pressione ENTER para começar', C_WHEAT,
